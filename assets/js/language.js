...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const languages = {
        tr: {
            ...
            project6_desc:"Makine arızalarını önceden tahmin eden akıllı IoT sistemi. Raspberry Pi ve yapay zeka ile titreşim analizi yapar, anormallikte anında uyarı gönderir. Endüstriyel bakım maliyetlerini düşürür.",
            project7_desc:"Fabrika ve depo ortamlarında forkliftlerin gerçek zamanlı performansını, operatör verimliliğini ve güvenlik parametrelerini izleyen IoT tabanlı bir sistem. Sensör verileriyle anlık analiz yaparak kaza riskini azaltır ve operasyonel verimliliği artırır.",
            project8_desc:"HavaVigil, endüstriyel boyahanelerde VOC ve CO seviyelerini gerçekime izleyerek havalandırma verimliliğini optimize eden ve operatörleri anormal durumlara karşı uyaran IoT tabanlı akıllı izleme çözümüdür. ESP32 ve profesyonel gaz sensörleriyle donatılan sistem, hem yerel hem de bulut tabanlı veri takibi sunarak proses güvenliği ve enerji verimliliğini eşzamanlı olarak iyileştirir.",
            ...
            project7_title:"Akıllı Forklift Performans İzleme Sistemi",
            project8_title:"HavaVigil: Boyahane Havalandırma ve Emisyon İzleme Sistemi",
            project2_card:"Sensör",
            project4_card:"Windows Uygulaması",
            project5_card:"Otonom Robot",
            proje6_card:"Titreşim",
            proje6_card2:"Makine Arıza",
            proje8_card2:"Akıllı İzleme",
            project6_title:"Makine Sağlığı İzleme ve Arıza Öngörü Sistemi",
            blog_title: "Blog",
        ...
        en: {
            ...
            project6_desc:"Intelligentes IoT-System, das Maschinenausfälle vorhersagt. Es führt mit Raspberry Pi und künstlicher Intelligenz eine Schwingungsanalyse durch und sendet bei Anomalien sofort eine Warnung. Senkt die Kosten für die industrielle Wartung..",
            project7_desc:"An IoT-based system that monitors the real-time performance of forklifts, operator efficiency, and safety parameters in factory and warehouse environments. By performing instant analysis with sensor data, it reduces the risk of accidents and increases operational efficiency.",
            project8_desc:"HavaVigil is an IoT-based smart monitoring solution that optimizes ventilation efficiency by continuously monitoring VOC and CO levels in industrial paint shops and alerts operators to abnormal conditions. Equipped with ESP32 and professional gas sensors, the system offers both local and cloud-based data tracking, simultaneously improving process safety and energy efficiency.",
            ...
            project7_title:"Smart Forklift Performance Monitoring System",
            project8_title:"HavaVigil: Paint Shop Ventilation and Emission Monitoring System",
            project2_card:"Sensor",
            project4_card:"Windows Application",
            project5_card:"Autonomous Robot",
            proje6_card:"Vibration",
            proje6_card2:"Machine failure",
            proje8_card2:"Smart Monitoring",
            project6_title:"Machine Health Monitoring and Fault Prediction System",
            blog_title: "Blog",
